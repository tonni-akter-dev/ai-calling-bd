    ...
    <div className="min-h-screen w-full bg-[#070d1e] flex items-center justify-center p-4 relative overflow-hidden font-sans antialiased">
      ...
      <div className="w-full max-w-md bg-[#0f172a]/90 backdrop-blur-xl rounded-3xl border border-slate-800 shadow-2xl overflow-hidden relative z-10">
        ...
        <div className="bg-linear-to-r from-blue-600 to-indigo-600 px-8 py-8 text-center text-white relative">
          {/* Subtle curved bottom clip */}
          <div className="absolute inset-x-0 bottom-0 h-4 bg-[#0f172a] clip-path-curve" style={{ clipPath: "ellipse(75% 100% at 50% 100%)" }} />
          
          <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-1">
            Welcome to <span className="text-orange-400">AI Call BD</span>
          </h1>
        ...
        <div className="p-8 pt-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white py-3.5 rounded-xl text-sm font-bold transition duration-200 flex items-center justify-center space-x-2 shadow-lg shadow-blue-600/25 mt-2"
            >
              <span>LOGIN</span>
