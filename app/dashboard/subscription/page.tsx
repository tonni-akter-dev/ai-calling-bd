        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 md:p-8 text-white">
          ...
          <div className="mt-6 pt-6 border-t border-white/20 flex flex-wrap gap-3">
            <button
              ...
              className="bg-white text-blue-600 px-6 py-2.5 rounded-xl text-sm font-semibold hover:bg-blue-50 transition"
            >
              Go to Dashboard
            </button>
            <button
        ...
        {plans.map((plan: Plan) => {
          ...
          return (
            ...
            >
              {/* Most Popular Badge */}
              {isPopular && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-[11px] font-bold px-4 py-1 rounded-full uppercase tracking-wider shadow-md">
                  Most Popular
                </div>
              )}
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-xs md:text-sm font-medium">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center mr-3 shrink-0 ${isPopular ? "bg-blue-500 text-slate-950" : "bg-blue-600 text-white"}`}>
