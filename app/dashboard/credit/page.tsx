...
const handleBkashPayment = async () => {
  ...
  return (
    <div className="space-y-6 mx-auto bg-slate-50 min-h-screen p-4 md:p-6 text-slate-800">
      {/* Top Banner Section */}
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-blue-600 via-indigo-600 to-blue-700 p-6 md:p-8 shadow-md border border-blue-500/20 text-white">
        ...
        <div className="lg:col-span-5 bg-white rounded-2xl border border-slate-200 p-5 md:p-6 shadow-sm flex flex-col">
          ...
          <div className="mt-6 pt-4 border-t border-slate-200 space-y-3">
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl shadow-md shadow-blue-600/10 transition active:scale-[0.99] flex items-center justify-center space-x-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
