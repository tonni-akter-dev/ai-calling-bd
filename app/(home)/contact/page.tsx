...
// 1. Import EmailJS instead of RTK Query
import emailjs from "@emailjs/browser";
import { toast } from "sonner";

export default function ContactPage() {
  // 2. Use local state for loading instead of RTK Query
  ...
  // 3. Updated Handler to use EmailJS
      ...
      <section className="relative bg-[#0b1329] text-white pt-40 pb-28 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <p className="text-slate-300 text-sm md:text-base max-w-xl mx-auto font-normal">
            We're here to help you build a better communication system. <br />{" "}
            Reach out anytime.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 md:p-10 border border-slate-100 shadow-md">
            ...
            <p className="text-xs text-slate-500 leading-relaxed mb-8">
              ...
              24 hours. We're happy to help with any questions about our
              services.
            </p>
            ...
            <div className="bg-[#0b1329] text-white rounded-3xl p-8 border border-slate-800 shadow-xl space-y-4">
              ...
              <div className="pt-2">
                <div className="bg-slate-900/90 border border-slate-800 rounded-xl px-4 py-3 text-[11px] text-slate-400">
                  <span className="text-blue-400 font-semibold">IPCallBD</span>{" "}
                  is a sub-brand of{" "}
                  <span className="text-white font-medium">Flemsoft</span>.
                </div>
              </div>
            </div>
