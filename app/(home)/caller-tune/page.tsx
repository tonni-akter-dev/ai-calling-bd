        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 md:p-10 border border-slate-100 shadow-xs">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Link
                href="/caller-tune"
                className="w-full sm:w-auto bg-primary hover:bg-blue-700 text-white px-6 py-3 rounded-xl text-xs font-semibold transition inline-flex items-center justify-center space-x-2"
              >
